...
const char* ei_classifier_inferencing_categories[] = { "tomato-bacterial-spot", "tomato-early-blight", "tomato-healthy", "tomato-late-blight", "tomato-leaf-mold", "tomato-leaf-spot", "tomato-mosaic-virus", "tomato-spider-mites", "tomato-target-spot", "tomato-yellow-leaf-curl-virus" };
...
const ei_impulse_t impulse_554068_0 = {
    .project_id = 554068,
    .project_owner = "Brijesh Mehta",
    .project_name = "plant-disease-tomato",
    .impulse_id = 1,
    .impulse_name = "Image data (EON Tuner Primary), Image (EON Tuner Primary), Transfer Learning (Images) (EON Tuner Primary)",
    .deploy_version = 6,
...
ei_impulse_handle_t impulse_handle_554068_0 = ei_impulse_handle_t( &impulse_554068_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_554068_0;
